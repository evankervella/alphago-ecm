...
class GameState(object):
    ...
    def get_group(self, position: tuple) -> list:
    ...
    def get_groups_around(self, position: tuple) -> list:
    ...
    def _on_board(self, position: tuple) -> bool:
        """Return True iff position is within the bounds of [0, self.size]
        """
        (x, y) = position
    ...
    def _neighbors(self, position: tuple) -> list:
    ...
    def _diagonals(self, position: tuple) -> list:
    ...
    def _update_neighbors(self, position: tuple) -> None:
    ...
    def _remove_group(self, group: list) -> None:
    ...
    def copy(self):
        ...
        def get_copy(s, set_copies: set={}) -> object:
    ...
    def is_suicide(self, action: tuple) -> bool:
        """Returns True if having current_player play at <action> would be suicide
    ...
    def is_positional_superko(self, action: tuple) -> None:
        """Finds all actions that the current_player has done in the past, taking into
    ...
    def is_legal(self, action: tuple) -> bool:
    ...
    def is_eyeish(self, position: tuple, owner: int) -> bool:
    ...
    def is_eye(self, position: tuple, owner: int, stack: list=[]) -> bool:
    ...
    def get_legal_moves(self, include_eyes: bool=True) -> list:
    ...
    def get_winner(self) -> int:
        """Calculates score of board state and return player ID (1, -1, or 0 for tie)
        corresponding to winner
        Uses 'Area scoring'
        """
    ...
    def place_handicaps(self, actions: list) -> None:
    ...
    def do_move(self, action: tuple, color: str=None) -> None:
